	...
	public String execute()  throws Exception {
		...
		if(username != null && password != null && username != "" && password !="" && username != "null" && password != "null"
			...
			if (userMaster != null) {
				...
				if(userTypeString.equalsIgnoreCase("PA")){
				...
				}else if((userTypeString.equalsIgnoreCase("TC")) || (userTypeString.equalsIgnoreCase("NTS")) || (userTypeString.equalsIgnoreCase("AD"))){
					...
					session.put("pdID", studentDetails.getStuId()+"");
