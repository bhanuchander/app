...
public class FranchiseMaster implements java.io.Serializable {
	...
	/** minimal constructor */
	public FranchiseMaster(String imId, String fname, String lname,
			String mobile, String email, String addr1, String stateId) {
		this.imId = imId;
		this.fname = fname;
		this.lname = lname;
		this.mobile = mobile;
	...
	/** full constructor */
	public FranchiseMaster(String imId, String smId, String bmId,
			String franShortname, String franName, String fname, String lname,
			String mobile, String email, String addr1, String addr2,
			String stateId, String active) {
		this.imId = imId;
		this.smId = smId;
		this.bmId = bmId;
