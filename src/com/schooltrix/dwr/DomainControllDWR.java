...
public class DomainControllDWR {
	...
	public String domainControllerCheck() {
		...
		try {
			...
			//	if (domainName.toLowerCase().equalsIgnoreCase("superadmin.schooltrix.com")) {
			...
			//	if(domainName.toLowerCase().contains("schooltrix.com".toLowerCase()) || domainName.toLowerCase().endsWith("schooltrix.com".toLowerCase())){
