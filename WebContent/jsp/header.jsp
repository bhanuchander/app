...
<meta charset="utf-8">
<title>Welcome to SchollTrix</title>
...
//        var SuperAdmin ='{"School Setup":{"Create Institution":"Access.action?p1=SA_inst1&p2=SA_inst2","Create Admin User":"Access.action?p1=AddAdminUser&p2=SA_inst2"},"Communication":{"Upload Document":"Access.action?p1=UploadDocuments&p2=SA_inst2","Send SMS":"Access.action?p1=UserSMS&p2=SA_inst2","Send Email":"Access.action?p1=UserEmail&p2=SA_inst2"}}';
 ...
 //       var Admin='{"School Setup":{"Add School":"Access.action?p1=schoolMaster&p2=SA_inst2","Add Branch":"Access.action?p1=branchMaster&p2=SA_inst2","Add Class":"#Access.action?p1=SA_inst1&p2=SA_inst2","Add Section":"#Access.action?p1=SA_inst1&p2=SA_inst2", "Add Staff":"Access.action?p1=AddNonAdminUser&p2=ffats","Add Students":"Access.action?p1=AddNonAdminUser&p2=uts","Add Parents":"Access.action?p1=AddNonAdminUser&p2=rap","Upload Class List":"Access.action?p1=classMaster&p2=SA_inst2", "Upload Section List":"Access.action?p1=sectionMaster&p2=SA_inst2","Upload Student Data":"Access.action?p1=studentMaster&p2=SA_inst2"}, "Communication":{"Upload Document":"Access.action?p1=UploadDocuments&p2=SA_inst2","Send SMS":"Access.action?p1=UserSMS&p2=SA_inst2", "Send Email":"Access.action?p1=UserEmail&p2=SA_inst2"}}';
        var Admin='{"School Setup":{"Add School":"Access.action?p1=schoolMaster&p2=SA_inst2","Add Branch":"Access.action?p1=branchMaster&p2=SA_inst2","Add Class":"#Access.action?p1=SA_inst1&p2=SA_inst2","Add Section":"#Access.action?p1=SA_inst1&p2=SA_inst2","Add Staff":"Access.action?p1=AddNonAdminUser&p2=ffats","Add Students":"Access.action?p1=AddNonAdminUser&p2=uts","Add Parents":"Access.action?p1=AddNonAdminUser&p2=rap"},"Communication":{"Upload Document":"Access.action?p1=UploadDocuments&p2=SA_inst2","Send SMS":"Access.action?p1=UserSMS&p2=SA_inst2","Send Email":"Access.action?p1=UserEmail&p2=SA_inst2"},"Bulk Upload":{"Upload Class Master":"Access.action?p1=classMaster&p2=SA_inst2","Upload Section Master":"Access.action?p1=sectionMaster&p2=SA_inst2","Upload Student Master":"Access.action?p1=studentMaster&p2=SA_inst2"}}';
        ...
        var Parent='{"Parent View":"#Access.action?p1=ParentStartUp&p2=SA_inst2","Parent Reports":{"Report 1":"#Access.action?p1=SA_inst1&p2=SA_inst2","Report 2":"#","Report 3":"#"}}';
        var Student='{"Student View":"#Access.action?p1=StudentStartUp&p2=SA_inst2","Student Reports":{"Report 1":"#Access.action?p1=SA_inst1&p2=SA_inst2","Report 2":"#","Report 3":"#"}}';
...
<div class="navbar navbar-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a class="brand" href="#"><span style="color:#ec7717;">School</span><span style="color:#000;">Trix</span> Admin</a>
