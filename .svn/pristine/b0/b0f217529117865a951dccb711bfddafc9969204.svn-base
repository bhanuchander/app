...
public class StaffDetails implements java.io.Serializable {
	...
	/** minimal constructor */
	public StaffDetails(String firstName, String lastName, String address1,
			String state, String country, String email, String mobile,
	...
	public StaffDetails(Long umId, String firstName, String lastName,
			...
			String country, String designation, String email, String mobile,
